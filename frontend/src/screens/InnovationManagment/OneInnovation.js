      ...
      >
        ...
        >
          <svg
            ...
            viewBox="0 0 16 16"
            style={{ color: "rgb(83, 192, 142)" , marginRight:"20px"}}
          >
        ...
        >
          ...
          <strong>
            Address: <span>Kandy Road, Kaduwela, Malabe</span>
          </strong>
        </div>
        <p style={{
            padding:"10px 0",
        ...
        <Row>
                <img src="https://i.ibb.co/Xx6vdhv/live-support-banner-business-customer-care-service-concept-icons-set-contact-us-support-help-phone-c.jpg" alt="" 
