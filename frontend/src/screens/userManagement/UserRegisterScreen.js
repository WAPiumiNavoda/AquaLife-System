...
import Login from "../userManagement/UserLoginScreen"
...
const UserRegisterScreen = () => {
	...
	const resetHandler = async (e) => {
	  ...
	  axios
		  .post("http://localhost:5000/user/register", datas)
		  .then((response) => {
								...
								<Col md={6}>
									...
									<Form.Group controlId="adminName">
										...
										<Form.Group controlId="adminFormBasicNic">
 										...
 										<Form.Group controlId="adminFormBasicTelephone">
											<Form.Label>Telephone</Form.Label> 											<Form.Control
												type="text"
												value={telephone}
 												placeholder="Enter Telephone Number"
											onChange={(e) => setTelephone(e.target.value)}
										...
										{picMessage && <ErrorMessage variant="danger">{picMessage}</ErrorMessage>} 										<Form.Group controlId="pic">
											<Form.Label>Profile Picture</Form.Label>
											<Form.Control
                                                  onChange={(e) => postDetails(e.target.files[0])}                                                   id="custom-file"
                                                  type="file"
                                                   label="Upload Profile Picture"
												  custom                                                   accept="image/*"
                                             />
